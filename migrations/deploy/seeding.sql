...
INSERT INTO "job" (
    ...
    ('Electricien', 'Installation, réparation et maintenance des systèmes électriques et des appareils électriques.', 2),
    ...
    ('Educateur/trice spécialisé(e)', 'Soutien éducatif et pédagogique aux enfants et aux adolescents en difficulté.', 5),
    ...
    ('Educateur/éducatrice canin', 'Formation des chiens et de leurs propriétaires pour favoriser une relation harmonieuse et obéissante.', 13),
    ('Eleveur/éleveuse d''animaux de compagnie', 'Élevage et reproduction de races spécifiques d''animaux de compagnie.', 13),
